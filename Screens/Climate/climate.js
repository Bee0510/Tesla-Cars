...
const Climate_Screen = () => {
  ...
  const changeIconColor = () => {
    const newColor = iconColor === "red" ? "green" : "red";
    setIconColor(newColor);
  };
  const changeDoorColor = () => {
    const newdoor = doorColor === "gray" ? "green" : "gray";
    setDoorColor(newdoor);
  };
    ...
    <SafeAreaView className="flex-1 bg-gray-900">
      <View className="flex-col justify-center items-center">
        ...
        <View className="flex-row items-center justify-center gap-4">
          <Text className="text-gray-400 text-lg">Interior 66°F</Text>
        ...
        <View className="flex-row justify-center mt-10 items-center gap-x-12">
          <TouchableOpacity onPress={changeIconColor}>
            <View className="flex-col justify-center items-center">
          ...
          <TouchableOpacity onPress={changeDoorColor}>
            <View className="flex-col justify-center items-center">
              <MaterialCommunityIcons
                name="car-door"
                size={40}
